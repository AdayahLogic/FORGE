...
from NEXUS.execution_truth import resolve_package_truth, update_execution_truth
...
def _build_execution_package_journal_record(normalized: dict[str, Any], package_path: str | None) -> dict[str, Any]:
    ...
    return {
        ...
        "autopilot_enabled": normalized.get("autopilot_enabled"),
        "autopilot_status": normalized.get("autopilot_status"),
        "autopilot_loop_state": normalized.get("autopilot_loop_state"),
        "autopilot_last_run_at": normalized.get("autopilot_last_run_at"),
        "autopilot_next_run_at": normalized.get("autopilot_next_run_at"),
        "autopilot_current_focus": normalized.get("autopilot_current_focus"),
        "autopilot_requires_operator_review": normalized.get("autopilot_requires_operator_review"),
        ...
        "mission_title": normalized.get("mission_title"),
        "mission_objective": normalized.get("mission_objective"),
        "mission_scope_boundary": normalized.get("mission_scope_boundary"),
        "mission_allowed_actions": normalized.get("mission_allowed_actions"),
        "mission_forbidden_actions": normalized.get("mission_forbidden_actions"),
        "mission_allowed_executors": normalized.get("mission_allowed_executors"),
        "mission_risk_level": normalized.get("mission_risk_level"),
        "mission_success_criteria": normalized.get("mission_success_criteria"),
        "mission_stop_conditions": normalized.get("mission_stop_conditions"),
        "mission_status": normalized.get("mission_status"),
        "mission_created_at": normalized.get("mission_created_at"),
        "mission_started_at": normalized.get("mission_started_at"),
        "mission_completed_at": normalized.get("mission_completed_at"),
        "mission_failed_at": normalized.get("mission_failed_at"),
        "mission_requires_initial_approval": normalized.get("mission_requires_initial_approval"),
        "mission_requires_final_approval": normalized.get("mission_requires_final_approval"),
        "mission_stop_condition_hit": normalized.get("mission_stop_condition_hit"),
        "mission_stop_condition_reason": normalized.get("mission_stop_condition_reason"),
        "mission_escalation_required": normalized.get("mission_escalation_required"),
        "executor_route": normalized.get("executor_route"),
        "executor_route_reason": normalized.get("executor_route_reason"),
        "executor_route_confidence": normalized.get("executor_route_confidence"),
        "executor_route_status": normalized.get("executor_route_status"),
        "executor_task_type": normalized.get("executor_task_type"),
        "executor_task_packet": normalized.get("executor_task_packet"),
        "executor_fallback_route": normalized.get("executor_fallback_route"),
        "approval_queue_item_type": normalized.get("approval_queue_item_type"),
        "approval_queue_risk_class": normalized.get("approval_queue_risk_class"),
        "approval_queue_reason": normalized.get("approval_queue_reason"),
        "approval_queue_batchable": normalized.get("approval_queue_batchable"),
        "approval_queue_requires_initial_approval": normalized.get("approval_queue_requires_initial_approval"),
        "approval_queue_requires_final_approval": normalized.get("approval_queue_requires_final_approval"),
        "approval_queue_escalation_reason": normalized.get("approval_queue_escalation_reason"),
        ...
        "qualification_status": str(normalized.get("qualification_status") or "unqualified"),
        "qualification_score": _normalize_revenue_ratio(normalized.get("qualification_score"), fallback=0.0),
        "qualification_reason": str(normalized.get("qualification_reason") or ""),
        "lead_value_estimate": float(normalized.get("lead_value_estimate") or 0.0),
        "urgency_level": str(normalized.get("urgency_level") or "low"),
        "offer_type": str(normalized.get("offer_type") or ""),
        "offer_summary": str(normalized.get("offer_summary") or ""),
        "offer_price_estimate": str(normalized.get("offer_price_estimate") or ""),
        "offer_value_proposition": str(normalized.get("offer_value_proposition") or ""),
        "offer_confidence": _normalize_revenue_ratio(normalized.get("offer_confidence"), fallback=0.0),
        "offer_customization_reason": str(normalized.get("offer_customization_reason") or ""),
        "objection_detected": bool(normalized.get("objection_detected")),
        "objection_type": str(normalized.get("objection_type") or "other"),
        "objection_reason": str(normalized.get("objection_reason") or ""),
        "objection_response_strategy": str(normalized.get("objection_response_strategy") or ""),
        "objection_response_draft": str(normalized.get("objection_response_draft") or ""),
        "closing_signal_detected": bool(normalized.get("closing_signal_detected")),
        "closing_signal_type": str(normalized.get("closing_signal_type") or "none"),
        "closing_confidence": _normalize_revenue_ratio(normalized.get("closing_confidence"), fallback=0.0),
        "recommended_closing_action": str(normalized.get("recommended_closing_action") or ""),
        "closing_message_draft": str(normalized.get("closing_message_draft") or ""),
        "conversation_id": str(normalized.get("conversation_id") or ""),
        "conversation_history": [dict(item) for item in list(normalized.get("conversation_history") or []) if isinstance(item, dict)][:30],
        "last_user_message": str(normalized.get("last_user_message") or ""),
        "last_forge_message": str(normalized.get("last_forge_message") or ""),
        "conversation_stage": str(normalized.get("conversation_stage") or "lead"),
        "conversation_last_updated_at": str(normalized.get("conversation_last_updated_at") or ""),
        ...
        "deal_status": str(normalized.get("deal_status") or "open"),
        "project_id": str(normalized.get("project_id") or ""),
        "project_created_at": str(normalized.get("project_created_at") or ""),
        "project_status": str(normalized.get("project_status") or "initialized"),
        "project_requirements_summary": str(normalized.get("project_requirements_summary") or ""),
        "project_scope": str(normalized.get("project_scope") or ""),
        "project_priority": str(normalized.get("project_priority") or "medium"),
        "build_required": bool(normalized.get("build_required")),
        "build_status": str(normalized.get("build_status") or "pending"),
        "build_mission_id": str(normalized.get("build_mission_id") or ""),
        "build_executor": str(normalized.get("build_executor") or "codex"),
        "build_scope_summary": str(normalized.get("build_scope_summary") or ""),
        "build_files_expected": [str(item) for item in list(normalized.get("build_files_expected") or []) if str(item).strip()][:50],
        "build_validation_requirements": [
            str(item) for item in list(normalized.get("build_validation_requirements") or []) if str(item).strip()
        ][:30],
        "setup_required": bool(normalized.get("setup_required")),
        "setup_status": str(normalized.get("setup_status") or "pending"),
        "setup_executor": str(normalized.get("setup_executor") or "openclaw"),
        "setup_steps_summary": str(normalized.get("setup_steps_summary") or ""),
        "setup_environment_requirements": str(normalized.get("setup_environment_requirements") or ""),
        "delivery_status": str(normalized.get("delivery_status") or "pending"),
        "delivery_type": str(normalized.get("delivery_type") or "other"),
...
def normalize_execution_package(package: dict[str, Any] | None) -> dict[str, Any]:
    ...
    project_delivery_fields = derive_project_delivery_fields(
        {
            **p,
            "metadata": metadata,
        }
    ...
    return {
        ...
        "review_status": str(p.get("review_status") or "pending").strip().lower(),
        "autopilot_enabled": bool(p.get("autopilot_enabled", False)),
        "autopilot_status": str(p.get("autopilot_status") or "idle").strip().lower(),
        "autopilot_loop_state": str(p.get("autopilot_loop_state") or "idle").strip().lower(),
        "autopilot_last_run_at": str(p.get("autopilot_last_run_at") or ""),
        "autopilot_next_run_at": str(p.get("autopilot_next_run_at") or ""),
        "autopilot_current_focus": str(p.get("autopilot_current_focus") or ""),
        "autopilot_requires_operator_review": bool(p.get("autopilot_requires_operator_review", False)),
        ...
        "runtime_artifacts": [x for x in runtime_artifacts[:20] if isinstance(x, dict)],
        "mission_id": str(p.get("mission_id") or ""),
        "mission_type": str(p.get("mission_type") or "project_delivery"),
        ...
        "mission_allowed_actions": [str(x) for x in (p.get("mission_allowed_actions") or []) if str(x).strip()][:30],
        "mission_forbidden_actions": [str(x) for x in (p.get("mission_forbidden_actions") or []) if str(x).strip()][:30],
        "mission_allowed_executors": [str(x) for x in (p.get("mission_allowed_executors") or []) if str(x).strip()][:10],
        "mission_risk_level": str(p.get("mission_risk_level") or "medium"),
        "mission_success_criteria": dict(p.get("mission_success_criteria") or {}),
        "mission_stop_conditions": [str(x) for x in (p.get("mission_stop_conditions") or []) if str(x).strip()][:20],
        "mission_status": str(p.get("mission_status") or "proposed"),
        ...
        "mission_stop_condition_hit": bool(p.get("mission_stop_condition_hit", False)),
        "mission_stop_condition_reason": str(p.get("mission_stop_condition_reason") or ""),
        "mission_escalation_required": bool(p.get("mission_escalation_required", False)),
        "executor_route": str(p.get("executor_route") or ""),
        "executor_route_reason": str(p.get("executor_route_reason") or ""),
        "executor_route_confidence": float(p.get("executor_route_confidence") or 0.0),
        "executor_route_status": str(p.get("executor_route_status") or ""),
        "executor_task_type": str(p.get("executor_task_type") or ""),
        "executor_task_packet": dict(p.get("executor_task_packet") or {}),
        "executor_fallback_route": str(p.get("executor_fallback_route") or ""),
        "approval_queue_item_type": str(p.get("approval_queue_item_type") or ""),
        "approval_queue_risk_class": str(p.get("approval_queue_risk_class") or ""),
        "approval_queue_reason": str(p.get("approval_queue_reason") or ""),
        "approval_queue_batchable": bool(p.get("approval_queue_batchable", False)),
        "approval_queue_requires_initial_approval": bool(p.get("approval_queue_requires_initial_approval", False)),
        "approval_queue_requires_final_approval": bool(p.get("approval_queue_requires_final_approval", False)),
        "approval_queue_escalation_reason": str(p.get("approval_queue_escalation_reason") or ""),
        ...
        **phase121_125_fields,
        ...
        "lead_value_estimate": float(p.get("lead_value_estimate") or 0.0),
        "urgency_level": str(p.get("urgency_level") or "low"),
        "offer_type": str(p.get("offer_type") or ""),
        "offer_summary": str(p.get("offer_summary") or ""),
        "offer_price_estimate": str(p.get("offer_price_estimate") or ""),
        "offer_value_proposition": str(p.get("offer_value_proposition") or ""),
        "offer_confidence": _normalize_revenue_ratio(p.get("offer_confidence"), fallback=0.0),
        "offer_customization_reason": str(p.get("offer_customization_reason") or ""),
        "objection_detected": bool(p.get("objection_detected")),
        "objection_type": str(p.get("objection_type") or "other"),
        "objection_reason": str(p.get("objection_reason") or ""),
        "objection_response_strategy": str(p.get("objection_response_strategy") or ""),
        "objection_response_draft": str(p.get("objection_response_draft") or ""),
        "closing_signal_detected": bool(p.get("closing_signal_detected")),
        "closing_signal_type": str(p.get("closing_signal_type") or "none"),
        "closing_confidence": _normalize_revenue_ratio(p.get("closing_confidence"), fallback=0.0),
        "recommended_closing_action": str(p.get("recommended_closing_action") or ""),
        "closing_message_draft": str(p.get("closing_message_draft") or ""),
        ...
        "last_user_message": str(p.get("last_user_message") or ""),
        "last_forge_message": str(p.get("last_forge_message") or ""),
        "conversation_stage": str(p.get("conversation_stage") or "lead"),
        "conversation_last_updated_at": str(p.get("conversation_last_updated_at") or ""),
...
def normalize_execution_package_journal_record(record: dict[str, Any] | None) -> dict[str, Any]:
    ...
    normalized = {
        ...
        "autopilot_enabled": bool(r.get("autopilot_enabled", False)),
        "autopilot_status": str(r.get("autopilot_status") or "idle").strip().lower(),
        "autopilot_loop_state": str(r.get("autopilot_loop_state") or "idle").strip().lower(),
        "autopilot_last_run_at": str(r.get("autopilot_last_run_at") or ""),
        "autopilot_next_run_at": str(r.get("autopilot_next_run_at") or ""),
        "autopilot_current_focus": str(r.get("autopilot_current_focus") or ""),
        "autopilot_requires_operator_review": bool(r.get("autopilot_requires_operator_review", False)),
        ...
        "mission_type": str(r.get("mission_type") or "project_delivery"),
        "mission_title": str(r.get("mission_title") or ""),
        "mission_objective": str(r.get("mission_objective") or ""),
        "mission_scope_boundary": dict(r.get("mission_scope_boundary") or {}),
        "mission_allowed_actions": [str(x) for x in (r.get("mission_allowed_actions") or []) if str(x).strip()][:30],
        "mission_forbidden_actions": [str(x) for x in (r.get("mission_forbidden_actions") or []) if str(x).strip()][:30],
        "mission_allowed_executors": [str(x) for x in (r.get("mission_allowed_executors") or []) if str(x).strip()][:10],
        "mission_risk_level": str(r.get("mission_risk_level") or "medium"),
        "mission_success_criteria": dict(r.get("mission_success_criteria") or {}),
        "mission_stop_conditions": [str(x) for x in (r.get("mission_stop_conditions") or []) if str(x).strip()][:20],
        "mission_status": str(r.get("mission_status") or "proposed"),
        "mission_created_at": str(r.get("mission_created_at") or ""),
        "mission_started_at": str(r.get("mission_started_at") or ""),
        "mission_completed_at": str(r.get("mission_completed_at") or ""),
        "mission_failed_at": str(r.get("mission_failed_at") or ""),
        "mission_requires_initial_approval": bool(r.get("mission_requires_initial_approval", True)),
        "mission_requires_final_approval": bool(r.get("mission_requires_final_approval", True)),
        "mission_stop_condition_hit": bool(r.get("mission_stop_condition_hit")),
        "mission_stop_condition_reason": str(r.get("mission_stop_condition_reason") or ""),
        "mission_escalation_required": bool(r.get("mission_escalation_required")),
        "executor_route": str(r.get("executor_route") or ""),
        "executor_route_reason": str(r.get("executor_route_reason") or ""),
        "executor_route_confidence": float(r.get("executor_route_confidence") or 0.0),
        "executor_route_status": str(r.get("executor_route_status") or ""),
        "executor_task_type": str(r.get("executor_task_type") or ""),
        "executor_task_packet": dict(r.get("executor_task_packet") or {}),
        "executor_fallback_route": str(r.get("executor_fallback_route") or ""),
        "approval_queue_item_type": str(r.get("approval_queue_item_type") or ""),
        "approval_queue_risk_class": str(r.get("approval_queue_risk_class") or ""),
        "approval_queue_reason": str(r.get("approval_queue_reason") or ""),
        "approval_queue_batchable": bool(r.get("approval_queue_batchable", False)),
        "approval_queue_requires_initial_approval": bool(r.get("approval_queue_requires_initial_approval", False)),
        "approval_queue_requires_final_approval": bool(r.get("approval_queue_requires_final_approval", False)),
        "approval_queue_escalation_reason": str(r.get("approval_queue_escalation_reason") or ""),
        ...
        "lead_value_estimate": float(r.get("lead_value_estimate") or 0.0),
        "urgency_level": str(r.get("urgency_level") or "low"),
        "offer_type": str(r.get("offer_type") or ""),
        "offer_summary": str(r.get("offer_summary") or ""),
        "offer_price_estimate": str(r.get("offer_price_estimate") or ""),
        "offer_value_proposition": str(r.get("offer_value_proposition") or ""),
        "offer_confidence": _normalize_revenue_ratio(r.get("offer_confidence"), fallback=0.0),
        "offer_customization_reason": str(r.get("offer_customization_reason") or ""),
        "objection_detected": bool(r.get("objection_detected")),
        "objection_type": str(r.get("objection_type") or "other"),
        "objection_reason": str(r.get("objection_reason") or ""),
        "objection_response_strategy": str(r.get("objection_response_strategy") or ""),
        "objection_response_draft": str(r.get("objection_response_draft") or ""),
        "closing_signal_detected": bool(r.get("closing_signal_detected")),
        "closing_signal_type": str(r.get("closing_signal_type") or "none"),
        "closing_confidence": _normalize_revenue_ratio(r.get("closing_confidence"), fallback=0.0),
        "recommended_closing_action": str(r.get("recommended_closing_action") or ""),
        "closing_message_draft": str(r.get("closing_message_draft") or ""),
        "conversation_id": str(r.get("conversation_id") or ""),
        "conversation_history": [dict(item) for item in list(r.get("conversation_history") or []) if isinstance(item, dict)][:30],
        "last_user_message": str(r.get("last_user_message") or ""),
        "last_forge_message": str(r.get("last_forge_message") or ""),
        "conversation_stage": str(r.get("conversation_stage") or "lead"),
        "conversation_last_updated_at": str(r.get("conversation_last_updated_at") or ""),
        ...
        "deal_status": str(r.get("deal_status") or "open"),
        "project_id": str(r.get("project_id") or ""),
        "project_created_at": str(r.get("project_created_at") or ""),
        "project_status": str(r.get("project_status") or "initialized"),
        "project_requirements_summary": str(r.get("project_requirements_summary") or ""),
        "project_scope": str(r.get("project_scope") or ""),
        "project_priority": str(r.get("project_priority") or "medium"),
        "build_required": bool(r.get("build_required")),
        "build_status": str(r.get("build_status") or "pending"),
        "build_mission_id": str(r.get("build_mission_id") or ""),
        "build_executor": str(r.get("build_executor") or "codex"),
        "build_scope_summary": str(r.get("build_scope_summary") or ""),
        "build_files_expected": [str(item) for item in list(r.get("build_files_expected") or []) if str(item).strip()][:50],
        "build_validation_requirements": [
            str(item) for item in list(r.get("build_validation_requirements") or []) if str(item).strip()
        ][:30],
        "setup_required": bool(r.get("setup_required")),
        "setup_status": str(r.get("setup_status") or "pending"),
        "setup_executor": str(r.get("setup_executor") or "openclaw"),
        "setup_steps_summary": str(r.get("setup_steps_summary") or ""),
        "setup_environment_requirements": str(r.get("setup_environment_requirements") or ""),
        "delivery_status": str(r.get("delivery_status") or "pending"),
        "delivery_type": str(r.get("delivery_type") or "other"),
        "delivery_payload_summary": str(r.get("delivery_payload_summary") or ""),
        "delivery_requires_approval": bool(r.get("delivery_requires_approval", True)),
        "post_delivery_status": str(r.get("post_delivery_status") or "pending"),
        "satisfaction_check_required": bool(r.get("satisfaction_check_required", True)),
...
def record_execution_package_revenue_loop(
    *,
    ...
    allowed_fields = {
        ...
        "offer_type",
        "offer_summary",
        "offer_price_estimate",
        "offer_value_proposition",
        "offer_confidence",
        "offer_customization_reason",
        "objection_detected",
        "objection_type",
        "objection_reason",
        "objection_response_strategy",
        "objection_response_draft",
        "closing_signal_detected",
        "closing_signal_type",
        "closing_confidence",
        "recommended_closing_action",
        ...
        "satisfaction_check_required",
        "satisfaction_status",
        "upsell_opportunity_detected",
        "retention_follow_up_required",
        "conversation_id",
