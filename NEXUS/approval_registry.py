...
def normalize_approval_record(record: dict[str, Any]) -> dict[str, Any]:
    ...
    out: dict[str, Any] = {
        ...
        "context": context,
        "triage_category": str(r.get("triage_category") or "internal_low_risk"),
        "triage_priority": str(r.get("triage_priority") or "low"),
        "triage_batchable": bool(r.get("triage_batchable", False)),
        "triage_batch_key": str(r.get("triage_batch_key") or ""),
