...
EXECUTION_ENVIRONMENT_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "controlled_external_bounded": {
        "environment_id": "controlled_external_bounded",
        "display_name": "Controlled External Bounded",
        "status": "active",
        "isolation_level": "bounded",
        "mutation_posture": "bounded",
        ...
        "human_review_required": True,
        "bounded_execution": True,
        "notes": "Controlled executor boundary for reviewed packages; bounded by AEGIS, file_guard, and package-state gates.",
    },
    "isolated_planned": {
...
RUNTIME_TARGET_TO_ENVIRONMENT: dict[str, str] = {
    ...
    "codex": "local_bounded",
    "openclaw": "controlled_external_bounded",
