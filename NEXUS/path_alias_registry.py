...
PATH_ALIAS_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        "legacy_name": "core",
        "current_name": "NEXUS",
        "logical_role": "orchestration_dir",
        "migration_status": "migrated",
        "notes": "Orchestration directory renamed from core/ to NEXUS/.",
    },
    {
        "legacy_name": "projects/nexus",
        "current_name": "projects/jarvis",
        "logical_role": "project_path",
        "migration_status": "migrated",
        "notes": "Physical path for logical project jarvis. Folder renamed from nexus to jarvis.",
    },
    {
        "legacy_name": "nexus",
        "current_name": "jarvis",
        ...
        "migration_status": "migrated",
        "notes": "Logical project jarvis; physical folder renamed to jarvis.",
    },
]
