...
from NEXUS.studio_config import STUDIO_ROOT, LEGACY_STUDIO_FOLDER_NAME
from NEXUS.path_alias_registry import (
    INTENDED_ROOT_NAME,
    LEGACY_ROOT_NAMES,
...
def analyze_path(path: str | Path) -> dict[str, Any]:
    ...
    if not alias_detected and ("/core" in norm_lower or "\\core" in norm_lower or norm_lower.rstrip("/").endswith("core")):
        alias_detected = True
        logical_name = "NEXUS"
